...
break;
	...
	int userSettings = input.nextInt();
	switch (userSettings) {
...
case 8: 
	...
	int userCalculator = input.nextInt();
...
case 9: 
	...
	int userReminder = input.nextInt();
	switch (userReminder) {
